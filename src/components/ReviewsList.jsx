        ...
        <Slider {...settings}>
          {reviews.map((review) => (
            <div key={review._id} className="p-4">
              <div className="bg-color rounded-xl p-6 shadow-md hover:shadow-lg transition-all h-full">
                ...
                <p className="text-gray-700 dark:text-gray-400 text-sm leading-relaxed">❝ {review.comment} ❞</p>
              </div>
            </div>
          ))}
        </Slider>
